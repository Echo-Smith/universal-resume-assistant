...
一款证据驱动、隐私优先的通用简历 Skill。提供简历、项目材料或 JD，即可完成事实审计、岗位匹配、招聘信息可信度与风险判断、经历提炼、定向改写和多格式交付。
...
- 将岗位匹配与机会风险分开判断，检查招聘主体、劳动条件、收费或培训贷、敏感信息索取及常见诈骗信号。
...
| 机会风险 | 分离劳动合规、主体可信度、诈骗与个人信息风险，给出证据、置信度与下一步核查 |
...
```text
使用 $universal-resume-assistant 评估这份岗位的匹配度、招聘主体可信度、劳动用工和个人信息风险，并告诉我投递前需要核实什么。
```
